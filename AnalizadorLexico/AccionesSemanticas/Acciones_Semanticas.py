...
class AccionesSemanticas:
    ...
    [  self.AS2,   self.AS2,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS3,   self.AS2,   self.AS2,   self.AS2,   self.AS2,   self.AS3,   self.AS3,   self.AS3, self.E2],  # 1
    [  self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS7,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1, self.E2],  # 2
    ...
    [  self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0,   self.AS0, self.E2],  # 4
