...
class AccionesSemanticas:
    ...
    [  self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS7,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1,   self.AS1, self.E2,self.AS1],  # 2
    ...
    [   self.E1,    self.E4,   self.AS2,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4,    self.E4, self.E2,self.E4],  # 12
